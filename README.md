...
A [Dockerfile](https://github.com/nholuongut/healthchecks/tree/master/docker)
...
* Check out project code:
  ...
  ```sh
  git clone https://github.com/nholuongut/healthchecks.git
  ```
...
* Processes that need to be running constantly.
  ...
  *  `manage.py sendalerts` is the process that monitors checks and sends out
     ...
     to [define a systemd service](https://github.com/nholuongut/healthchecks/issues/273#issuecomment-520560304)
     for it.
...
release. The Dockerfile lives in the [/docker/](https://github.com/nholuongut/healthchecks/tree/master/docker)
