...
* Use uWSGI as the web server. uWSGI is configured to perform database migrations
  ...
  started conditionally, [based on the value of the `SMTPD_PORT` environment variable](https://github.com/nholuongut/healthchecks/tree/master/docker#smtp-listener-configuration-via-smtpd_port).
